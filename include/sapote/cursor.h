 ...
 * sapote/ui.h - is one fixed 18x25 bitmap with one fixed hotspot, and there
 ...
 * platform's pointer shows.  That is patch work in Sapote's own ui.c/ui.h,
 ...
 */
#ifndef SAPOTE_CURSOR_H
#define SAPOTE_CURSOR_H
