...
#ifndef SAPOTE_TASKBAR_H
#define SAPOTE_TASKBAR_H
 ...
 * This keeps the bar portable across Sapote's panels and its native windows
...
/*
 * An app icon supplied by the host.  Sapote already decodes its application
 ...
 * separate alpha plane, the same pair Sapote already decodes its application
 ...
 * last, because it is under every window; see sapote/cursor.h. */
 ...
 * here because Sapote has no timeline and no virtual desktops. */
