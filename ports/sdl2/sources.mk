...
# SDL 2.32.10 common sources plus Sapote's public-ABI platform backends.

SDL2_SOURCES := \
	$(wildcard vendor/sdl2/src/*.c) \
	$(wildcard vendor/sdl2/src/atomic/*.c) \
	$(wildcard vendor/sdl2/src/audio/*.c) \
	$(wildcard vendor/sdl2/src/audio/sapote/*.c) \
	...
	$(wildcard vendor/sdl2/src/filesystem/sapote/*.c) \
	...
	$(wildcard vendor/sdl2/src/thread/sapote/*.c) \
	$(wildcard vendor/sdl2/src/timer/*.c) \
	$(wildcard vendor/sdl2/src/timer/sapote/*.c) \
	$(wildcard vendor/sdl2/src/video/*.c) \
	$(wildcard vendor/sdl2/src/video/yuv2rgb/*.c) \
	$(wildcard vendor/sdl2/src/video/sapote/*.c)
