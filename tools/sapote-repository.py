#!/usr/bin/env python3
"""Build, verify, and resolve deterministic signed Sapote repository indexes."""
...
PACKAGE_TOOL_SPEC = importlib.util.spec_from_file_location(
    "sapote_repository_package_tool", PACKAGE_TOOL_PATH)
...
def main() -> int:
    try:
        ...
        print(f"Sapote repository refused: {error}", file=sys.stderr)
        return 1
    return 0
