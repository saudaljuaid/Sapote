...
An earlier version of this paragraph said Phipia *cannot run SapStudio*. It was
...
| Document | Contents |
| --- | --- |
| [Charter](docs/CHARTER.md) | What SapStudio is, what it refuses to be, and why it is Phipia-only |
