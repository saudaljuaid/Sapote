...
//!
//! [`sapstudio_core::Timecode`] is a *label* on a frame. WebVTT wants the
...
//!
//! So a cue's time comes from [`sapstudio_core::Instant::seconds`], which is
...
///   [`sapstudio_model::caption::MAX_VOICES`] is eight: **11**;
/// - the text is [`sapstudio_model::caption::MAX_CAPTION_TEXT`] **characters**. A character is at most
